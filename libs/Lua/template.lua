--
-- Based on https://github.com/EhsanFox/HTML-Lua
--
...
function template.print_render(view, context, key, plain)
    return template.print(template.render(view, context, key, plain))
end

for k,v in pairs(template) do _M[k] = v end
return _M;
